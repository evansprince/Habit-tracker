...
export default function StreakScrren() {
      ...
      const habitSubscription = client.subscribe(habitsChannel
        ...
        (response: RealTimeResponse) => {
          if (response.events.includes("database.*.collections.*.create")) {
            fetchHabits();
          } else if (response.events.includes("database.*.collections.*.update")) {
            fetchHabits();
          } else if (response.events.includes("database.*.collections.*.delete")) {
            fetchHabits();
          }
        } 
      );
        ...
        <View style={styles.cage}>
            ...
            { rankedHabits.length > 0 && (
              <View style={styles.rankingContainer}>
                <Text style={styles.rankingTitle}> 🏅 Top Straks</Text>
